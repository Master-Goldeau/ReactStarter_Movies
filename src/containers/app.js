...
class App extends Component {
  ...
  setRecommendation(){
    ...
    axios.get(`${API_END_POINT}movie/${this.state.currentMovie.id}/recommendations?${API_KEY}&languafe=fr`).then(
      function(response) {
        this.setState(
          {
    ...
    return (
      <div>
        ...
        <div className="row">
          ...
          <div className="col-xs-12 col-sm-6 col-lg-4">{renderVideoList()}</div>
        </div>
      </div>
    );
  }
